...
Чтобы найти расстояние $x$ (расстояние после которого катер начнет двигаться вокруг полюса), необходимо составить простое уравнение. Пусть через время $t$ катер и лодка окажутся на одном расстоянииx от полюса. За это время лодка пройдет $x$ , а катер $k-x$ (или $k+x$, в зависимости от начального положения катера относительно полюса). Время, за которое они пройдут это расстояние, вычисляется как $\dfrac{x}{v}$ или $\dfrac{k-x}{3.5v}$ (во втором случае $\dfrac{k+x}{3.5v}$). Так как время одно и то же, то эти величины одинаковы. Тогда неизвестное расстояниеx можно найти из следующего уравнения:

$$
\dfrac{x}{v} = \dfrac{k-x}{3.5v} \text{ -- в первом случае}
$$
$$
\dfrac{x}{v} = \dfrac{k+x}{3.5v} \text{ -- во втором}
$$

Отсюда мы найдем два значения $x_1 = \dfrac{15.5}{4,5}$ и $x_2 = \dfrac{15.5}{2,5}$, задачу будем решать для двух случаев.
...
$$
\dfrac{dr}{d \theta} = \dfrac{r}{\sqrt{11.25}}
$$

Начальные условия остаются прежними. Решив это уравнение, мы получим траекторию движения катера в полярных координатах.(рис. [-@fig:001]).(рис. [-@fig:002]).(рис. [-@fig:003]).(рис. [-@fig:004]).(рис. [-@fig:005]).(рис. [-@fig:006]).

![код с начальными условиями](image/1.bmp){#fig:001 width=70%}


![траектория движения катера](image/2.bmp){#fig:002 width=70%}

![график пересечения катера и лодки](image/3.bmp){#fig:003 width=70%}

![постановка проблемы для 2 случая](image/4.bmp){#fig:004 width=70%}

![траектория движения катера против часовой](image/5.bmp){#fig:005 width=70%}

![пересечение для 2го случая](image/6.bmp){#fig:006 width=70%}
